...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    def _centerMagnifier(self, x, y):
        ...
        """
        zoom = self.zoom
        left, top, visibleWidth, visibleHeight = self._getMagnifierWindow(x, y)
        try:
            MagSetFullscreenTransform = self._getMagSetFullscreenTransform()
    ...
    def _isMouseNearBorder(self):
        ...
        Otherwise, return lastX and lastY.
        """
        left, top, visibleWidth, visibleHeight = self._getMagnifierWindow(self.lastX, self.lastY)
        mouseX, mouseY = self._getMousePosition()
        self.lastMousePos = mouseX, mouseY

        minX = left + MARGIN_BORDER
        maxX = left + visibleWidth - MARGIN_BORDER
        minY = top + MARGIN_BORDER
        maxY = top + visibleHeight - MARGIN_BORDER
